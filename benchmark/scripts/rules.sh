...
iptables -t nat -I PREROUTING -i $interface -p tcp -d 172.20.0.2 --dport 80 -j DNAT --to-destination 127.0.0.1:6002
...
sysctl -w net.ipv4.conf.srv-net-2.route_localnet=1
