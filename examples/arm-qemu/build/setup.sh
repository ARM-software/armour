...
cross build --target=arm-unknown-linux-musleabihf -p armour-certs --release
mkdir ~/bin
ln -s ~/src/target/arm-unknown-linux-musleabihf/release/{armour-certs,armour-proxy,armour-host} ~/bin
